...
export const useCreateEditor = ({ initialValue }: { initialValue?: any[] } = {}) => {
  // Ensure initialValue is an array
  const editorValue = Array.isArray(initialValue) && initialValue.length > 0 ? initialValue : DEFAULT_EDITOR_VALUE
