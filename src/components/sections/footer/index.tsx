            ...
            <div className="pt-[200px] w-full max-w-[1800px]">
                ...
                <div className="border-b border-[rgb(134,134,134)] pb-[100px] mx-[200px] relative">
                    <span className="flex items-center">
                        ...
                        <h2 className="text-[5vw] ml-[0.3em] font-bold ">Created by</h2>
                    </span>
                    <h2 className="text-[5vw] font-extrabold">Supernova</h2>
                    
                    <motion.div 
                        style={{ x }} 
                        className="absolute left-[calc(100%-400px)] top-[calc(100%-75px)]"
                    >
                        <Rounded backgroundColor="#334BD3" className="w-[180px] h-[180px] bg-[#455CE9] text-white rounded-full absolute flex items-center justify-center cursor-pointer">
                            <p className="m-0 text-[16px] font-light z-[2] relative">Contact Supernova</p>
                        </Rounded>
                    </motion.div>
                ...
                <div className="flex gap-5 mt-[100px] mx-[200px]">
                    <Rounded>
                        <p>supernovasoftwareco@gmail.com</p>
                    </Rounded>
                    <Rounded>
                        <p>+967 77 643 643 0</p>
                    </Rounded>
                </div>
